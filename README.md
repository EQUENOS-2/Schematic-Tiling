...
**The remaining X-flag** is `0`. It's the default value, and it simply means that the region should be transferred without any changes into the final schematic.
## `Z-flag`
...
![Example of Z-flag usage](images/stacking_4.png)
